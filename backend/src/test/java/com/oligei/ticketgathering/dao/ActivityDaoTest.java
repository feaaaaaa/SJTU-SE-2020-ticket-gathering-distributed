...
class ActivityDaoTest {
    ...
    void findOneById() {
        ...
        assertThrows(JpaObjectRetrievalFailureException.class,()->activityDao.findOneById(-1));
        assertThrows(JpaObjectRetrievalFailureException.class,()->activityDao.findOneById(0));

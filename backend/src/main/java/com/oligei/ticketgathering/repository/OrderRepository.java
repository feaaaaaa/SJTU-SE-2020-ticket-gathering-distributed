...
public interface OrderRepository extends JpaRepository<Order,Integer> {
   ...
   @Query(value="select new com.oligei.ticketgathering.entity.info.OrderInfo (o.orderId, o.userId, o.actitemId, o.price, o.amount,o.showtime,o.orderTime,at.title,at.venue,at.activityIcon) " +
